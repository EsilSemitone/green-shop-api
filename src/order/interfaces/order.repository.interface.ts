...
import { IGetAllOrdersByQuery, IGetAllOrdersByQueryReturn } from './get-all-orders-by-query.interface.ts';
...
export interface IOrderRepository {
    ...
    getAll(query: IGetAllOrdersByQuery): Promise<IGetAllOrdersByQueryReturn>;
}
